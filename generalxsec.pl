...
if (@ARGV > 12){print "Must input 6 string arguments: \n";
                print "    1) slab (e.g. alu, sam, phi) \n";
                print "    2) model date (MM.DD.YY) \n";
                print "    3) model directory name and location \n";
                print "    4) input file name and location \n";
...
if (@ARGV < 12 & @ARGV > 6){print "Must input 6 string arguments: \n";
                print "    1) slab (e.g. alu, sam, phi) \n";
                print "    2) model date (MM.DD.YY) \n";
                print "    3) model directory name and location \n";
                print "    4) input file name and location \n";
...
if (@ARGV == 12){($ID,$folder,$folderloc,$unfiltered,$tgs,$sp,$reg_trench,$caz,$guide,$xclen,$xclen2,$maxdepthplot)=@ARGV;}
